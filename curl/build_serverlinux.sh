...
openssl_prebuilt_path=`pwd`/../openssl/prebuilt/serverlinux
...
export CPPFLAGS="-I$openssl_prebuilt_path/include -g -Os -fPIC"

./configure --with-ssl=$openssl_prebuilt_path --prefix=$prebuilt_path \
						--enable-debug \
						--disable-curldebug \
						--disable-cookies			\
						--disable-crypto-auth	\
